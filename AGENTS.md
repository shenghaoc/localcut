...
- [**Phase 33: Smart Reframe**](.kiro/specs/phase-33-smart-reframe/tasks.md) — automatic crop-path generation between aspect ratios (16:9 ↔ 9:16, 1:1, 4:5); BlazeFace-class face detection via LiteRT.js in a lazy-loaded dedicated worker; pure-DSP saliency fallback for faceless footage; IoU-tracked primary subject with One Euro smoothing; shot-boundary detection via histogram difference; output as editable Phase 15 transform keyframes with velocity/acceleration bounds; review/apply overlay.
