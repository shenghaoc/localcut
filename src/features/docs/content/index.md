...
- **Caption**: import SRT/VTT subtitles, edit them inline, burn them in or export them — or auto-transcribe a clip on-device with the experimental Auto Captions (LiteRT Whisper) feature.
