...
- **Caption**: import SRT/VTT subtitles, edit them inline, restyle them with animated presets, burn them in or export them — or auto-transcribe a clip on-device with the experimental Auto Captions feature (Whisper on ONNX Runtime Web by default, or LiteRT). See [Captions](/docs/captions).
