      ...
      <Popover.Portal>
        <Popover.Content class="export-popover bundle-popover">
          <div class="export-popover-header">
            <h2 class="export-popover-title">Project bundle <span class="text-xs text-[#9898a4] font-normal">(Experimental)</span></h2>
          ...
          <Show when={props.busy || props.progressPhase || props.integrityReport || props.lastMessage}>
              ...
              <Show when={props.integrityReport}>
                {(report) => (
                  <div class="bundle-integrity">
                    ...
                    <ul>
                      <For each={report().items.filter((item: BundleIntegrityItemSnapshot) => item.code !== 'ok').slice(0, 8)}>
