  ...
  return [
    {
      ...
      active: probe.tier === 'core-webgpu' || (probe.tier === 'compatibility-webgpu' && !probe.compatibilityAdapter),
      action: probe.webGPUCore === 'supported' ? null : 'Enable hardware acceleration or use a WebGPU-capable browser.',
    },
    {
    ...
    },
    {
      ...
      action: probe.webCodecsDecode === 'supported' ? null : 'Use a browser with WebCodecs decode support.',
    },
    {
      label: 'VideoEncoder',
      support: probe.webCodecsEncode,
      active: probe.webCodecsEncode === 'supported' && probe.tier !== 'shell-only',
      action: probe.webCodecsEncode === 'supported' ? null : 'Export is limited without WebCodecs encode support.',
    },
    { label: 'H.264 decode', support: probe.codecs.h264Decode, active: probe.codecs.h264Decode === 'supported', action: null },
    { label: 'VP9 decode', support: probe.codecs.vp9Decode, active: probe.codecs.vp9Decode === 'supported', action: null },
    { label: 'AV1 decode', support: probe.codecs.av1Decode, active: probe.codecs.av1Decode === 'supported', action: null },
    { label: 'H.264 encode', support: probe.codecs.h264Encode, active: probe.codecs.h264Encode === 'supported', action: null },
    { label: 'VP9 encode', support: probe.codecs.vp9Encode, active: probe.codecs.vp9Encode === 'supported', action: null },
    { label: 'AV1 encode', support: probe.codecs.av1Encode, active: probe.tier === 'core-webgpu' && probe.codecs.av1Encode === 'supported', action: null },
    { label: 'AAC decode', support: probe.codecs.aacDecode, active: probe.codecs.aacDecode === 'supported', action: null },
    { label: 'Opus decode', support: probe.codecs.opusDecode, active: probe.codecs.opusDecode === 'supported', action: null },
    { label: 'AAC encode', support: probe.codecs.aacEncode, active: probe.codecs.aacEncode === 'supported', action: null },
    { label: 'Opus encode', support: probe.codecs.opusEncode, active: probe.codecs.opusEncode === 'supported', action: null },
    {
    ...
    },
    {
      ...
      action: probe.offscreenCanvas === 'supported' ? null : 'Preview tiers require worker-owned OffscreenCanvas.',
    },
    {
      label: 'File System Access',
      support: probe.fileSystemAccess,
      active: probe.fileSystemAccess === 'supported',
      action: probe.fileSystemAccess === 'supported' ? null : 'Exports use blob download when direct file saving is unavailable.',
    },
    { label: 'OPFS', support: probe.opfs, active: probe.opfs === 'supported', action: null },
    { label: 'AudioWorklet', support: probe.audioWorklet, active: probe.audioWorklet === 'supported', action: null },
  ];
}
