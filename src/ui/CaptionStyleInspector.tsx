...
function coerceAnimKind(value: string): AnimKind {
  return (ANIM_KINDS as readonly string[]).includes(value)
    ? (value as AnimKind)
    : "none";
}
...
export function serializeAndSavePreset(
  ...
  const safeStem =
    preset.label.replace(/[^a-z0-9-_]+/gi, "-").replace(/^-|-$/g, "") ||
    preset.id;
  const filename = `${safeStem}.caption-preset.json`;

  if (
    typeof (globalThis as Record<string, unknown>).showSaveFilePicker ===
    "function"
  ) {
    void (async () => {
      try {
...
export async function openAndImportPreset(): Promise<
  | { ok: true; preset: CaptionAnimStylePreset }
...
> {
  ...
  if (
    typeof (globalThis as Record<string, unknown>).showOpenFilePicker ===
    "function"
  ) {
    try {
      const [handle] = await (
...
function draftFromPreset(preset: UiPreset) {
  ...
  return {
    ...
    fontSizePx:
      typeof titleStyle.fontSizePx === "number" ? titleStyle.fontSizePx : 64,
    outlineColor: normalizeHexColor(titleStyle.outlineColor, "#000000"),
    outlineWidthPx:
      typeof titleStyle.outlineWidthPx === "number"
        ? titleStyle.outlineWidthPx
        : 4,
...
function presetFromDraft(
  ...
  return {
    ...
    ...(draft.glowEnabled
      ? { glow: { color: draft.glowColor, blurPx: draft.glowBlurPx } }
      : {}),
    ...(draft.pillEnabled
      ? {
          pill: {
...
export function CaptionStyleInspector(props: CaptionStyleInspectorProps) {
  ...
  const [importSuccess, setImportSuccessSignal] = createSignal<string | null>(
    null,
  );
  ...
  const [presetNameDraft, setPresetNameDraft] = createSignal<string | null>(
    null,
  );
  ...
  const [draft, setDraft] = createSignal<Draft>(
    draftFromPreset(ANIM_CAPTION_PRESETS[0]!),
  );
  createComputed(() => {
  ...
  const handleImport = async () => {
    ...
    const conflict = props.customPresets.find(
      (p) => p.label === incoming.label,
    );
    if (conflict) {
      setImportConflict({
        preset: incoming,
  ...
  return (
    <div
      class="caption-style-inspector"
      role="group"
      aria-label="Caption animation style"
    >
      {/* Preset picker grid */}
      <div
        class="caption-preset-grid"
        role="listbox"
        ...
        <div class="caption-overrides-row">
          ...
          <label>
            ...
            <input
              ...
              onInput={(e) =>
                updateDraft("fontSizePx", Number(e.currentTarget.value))
              }
            />
          </label>
          <label>
            ...
            <input
              ...
              onInput={(e) =>
                updateDraft("outlineColor", e.currentTarget.value)
              }
            />
          </label>
          <label>
            ...
            <input
              ...
              onInput={(e) =>
                updateDraft("outlineWidthPx", Number(e.currentTarget.value))
              }
            />
          </label>
        </div>
        ...
        <div class="caption-overrides-row">
          <label class="caption-overrides-toggle">
            <input
              ...
              onChange={(e) =>
                updateDraft("glowEnabled", e.currentTarget.checked)
              }
            />
            <span>Glow</span>
          </label>
          ...
          <label>
            ...
            <input
              ...
              onInput={(e) =>
                updateDraft("glowBlurPx", Number(e.currentTarget.value))
              }
            />
          </label>
        </div>
        ...
        <div class="caption-overrides-row">
          <label class="caption-overrides-toggle">
            <input
              ...
              onChange={(e) =>
                updateDraft("pillEnabled", e.currentTarget.checked)
              }
            />
            <span>Pill</span>
          </label>
          ...
          <label>
            ...
            <input
              ...
              onInput={(e) =>
                updateDraft("pillOpacity", Number(e.currentTarget.value))
              }
            />
          </label>
          <label>
            ...
            <input
              ...
              onInput={(e) =>
                updateDraft("pillRadiusPx", Number(e.currentTarget.value))
              }
            />
          </label>
        </div>
        ...
        <div class="caption-overrides-row">
          <label>
            ...
            <select
              ...
              onChange={(e) =>
                updateDraft("enterKind", coerceAnimKind(e.currentTarget.value))
              }
            >
              <For each={ANIM_KINDS}>
          ...
          <label>
            ...
            <select
              ...
              onChange={(e) =>
                updateDraft("exitKind", coerceAnimKind(e.currentTarget.value))
              }
            >
              <For each={ANIM_KINDS}>
                {(kind) => <option value={kind}>{kind}</option>}
          ...
          <label>
            ...
            <input
              ...
              onInput={(e) =>
                updateDraft("animDurationS", Number(e.currentTarget.value))
              }
            />
          </label>
        </div>
      ...
      <Show when={importError()}>
        <div
          class="caption-notice caption-notice-error"
          role="alert"
          aria-live="assertive"
        >
          {importError()}
      ...
      <Show when={importConflict()}>
        {(c) => (
          <div
            class="caption-notice caption-notice-warn"
            role="alertdialog"
            aria-modal="true"
          >
            <p>
      ...
      <Show when={presetNameDraft()}>
        {(label) => (
          <div
            class="caption-notice caption-notice-prompt"
            role="dialog"
            aria-modal="true"
          >
            <label>
