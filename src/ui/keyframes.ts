...
export function sortedKeyframes(track: readonly KeyframeSnapshot[] | undefined): KeyframeSnapshot[] {
  return [...(track ?? [])].sort((a, b) => a.t - b.t);
}

export function keyframeAt(track: readonly KeyframeSnapshot[] | undefined, localTime: number | null): KeyframeSnapshot | null {
...
export function sampleEffectsAt(
  ...
  return {
    ...
    temperatureStrength: sampleKeyframes(keyframes?.temperatureStrength, localTime, effects.temperatureStrength),
