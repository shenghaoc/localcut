...
const ASPECT_OPTIONS: ReframeTargetAspect[] = [
  "9:16",
  "1:1",
  "4:5",
  "16:9",
...
export const SmartReframePanel: Component<SmartReframePanelProps> = (props) => {
  ...
  const [targetAspect, setTargetAspect] =
    createSignal<ReframeTargetAspect>("9:16");
      ...
      >
        <header class="capability-panel-header">
          <div>
            ...
            <p class="capability-panel-tier">
              Generates editable transform keyframes on-device — no frames leave
              your browser.
            </p>
          </div>
          <Button
        ...
        <section class="diagnostics-section">
          ...
          >
            ...
            <select
              ...
              value={targetAspect()}
              onChange={(e) =>
                setTargetAspect(e.currentTarget.value as ReframeTargetAspect)
              }
              disabled={busy()}
            >
          ...
          <Show when={!props.selectedClip}>
            <p class="capability-panel-note">
              Select a video clip on the timeline to reframe.
            </p>
          </Show>
        </section>
        ...
        <section class="diagnostics-section">
          ...
          <Show when={confirmReplace()}>
            <p class="capability-panel-note" role="alert">
              This clip already has transform keyframes. Re-analysis will
              overwrite them.
            </p>
            ...
            return (
              <section class="diagnostics-section">
                ...
                <Show when={stats().safeZoneCompliance < 0.95}>
                  <p class="capability-panel-note">
                    The subject leaves the safe zone in some frames; widen the
                    bounds in Adjust or edit the keyframes by hand after
                    applying.
                  </p>
                </Show>
                ...
                <Show when={showAdjust()}>
                  ...
                  >
                    ...
                    <input
                      ...
                      value={velocityBound()}
                      onInput={(e) =>
                        setVelocityBound(parseFloat(e.currentTarget.value))
                      }
                    />
                    ...
                    <input
                      ...
                      onInput={(e) =>
                        setAccelerationBound(parseFloat(e.currentTarget.value))
                      }
                    />
                    <label for="reframe-fps">
                      Analysis rate ({analysisFps()} fps)
                    </label>
                    <input
                      id="reframe-fps"
                      type="range"
                      ...
                      value={analysisFps()}
                      onInput={(e) =>
                        setAnalysisFps(parseInt(e.currentTarget.value, 10))
                      }
                    />
