...
export function mergeInvalidations(...invalidations: readonly CacheInvalidation[]): CacheInvalidation {
  return {
...
export function transitionRange(timeline: Timeline, transition: TimelineTransition): TimeRange | null {
