...
function normalizeAlign(value: unknown): TitleAlign {
  return value === 'left' || value === 'right' || value === 'center' ? value : DEFAULT_TITLE_STYLE.align;
}
...
export function normalizeTitleStyle(partial: Partial<TitleStyle> | undefined): TitleStyle {
  ...
  return {
    ...
    backgroundOpacity: clamp(finiteOr(partial?.backgroundOpacity, DEFAULT_TITLE_STYLE.backgroundOpacity), 0, 1),
    outlineColor: normalizeColor(partial?.outlineColor, DEFAULT_TITLE_STYLE.outlineColor),
    outlineWidthPx: clamp(finiteOr(partial?.outlineWidthPx, DEFAULT_TITLE_STYLE.outlineWidthPx), 0, 64),
    ...
    shadowOffsetXPx: clamp(finiteOr(partial?.shadowOffsetXPx, DEFAULT_TITLE_STYLE.shadowOffsetXPx), -128, 128),
    shadowOffsetYPx: clamp(finiteOr(partial?.shadowOffsetYPx, DEFAULT_TITLE_STYLE.shadowOffsetYPx), -128, 128),
